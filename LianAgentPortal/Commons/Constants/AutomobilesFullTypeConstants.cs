namespace LianAgentPortal.Commons.Constants
{
    public static class AutomobilesFullTypeConstants
    {
        public static List<AutomobilesFullTypeObject> Data = new List<AutomobilesFullTypeObject>()
        {
            ...
            new AutomobilesFullTypeObject() { DisplayName = "XE TẬP LÁI (CHỞ NGƯỜI)", AutomobileType = AutomobileTypeEnum.TRAINER, Attributes_Seat = "", Attributes_Category = AutomobileTypeCategoryEnum.COMMERCIAL },
